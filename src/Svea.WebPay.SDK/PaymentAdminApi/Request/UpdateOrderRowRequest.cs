namespace Svea.WebPay.SDK.PaymentAdminApi.Request
{
    ...
    public class UpdateOrderRowRequest : OrderRowBase, IConfigurableAwait
    {
        ...
        /// <param name="discount">The discount amount of the product. Can be both amount or percent based on the use of useDiscountPercent.</param>
        ...
        public UpdateOrderRowRequest(string articleNumber, string name, MinorUnit quantity, MinorUnit unitPrice, MinorUnit discount, MinorUnit vatPercent, string unit, bool useDiscountPercent = false, bool configureAwait = false)
        {
