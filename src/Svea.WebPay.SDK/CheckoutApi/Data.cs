namespace Svea.WebPay.SDK.CheckoutApi
{
    ...
    public class Data : OrderData
    {
        ...
        public Data(MerchantSettings merchantSettings, Cart cart, Customer customer, Address shippingAddress, Address billingAddress, Gui gui, string locale, string currency,
           ...
           BillingReferenceModel[] billingReferences, bool? recurring, string recurringToken = null, OrderValidation validation = null) : base(merchantSettings, cart, customer, shippingAddress, billingAddress, locale, currency, countryCode,
            presetValues, clientOrderNumber, orderId, emailAddress, phoneNumber, paymentType, status, customerReference,
            sveaWillBuyOrder, identityFlags, merchantData, payment, peppolId, shippingInformation, billingReferences, recurring, recurringToken, validation)
        {
            Gui = gui;
        }
