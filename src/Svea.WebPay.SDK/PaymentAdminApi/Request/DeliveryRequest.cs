namespace Svea.WebPay.SDK.PaymentAdminApi.Request
{
    ...
    public class DeliveryRequest : IResourceRequest
    {
        ...
        public DeliveryRequest(IList<long> orderRows, InvoiceDistributionType? invoiceDistributionType = null, RowDeliveryOptions rowDeliveryOptions = null, TimeSpan? pollingTimeout = null)
        {
        ...
        public RowDeliveryOptions RowDeliveryOptions { get; }
