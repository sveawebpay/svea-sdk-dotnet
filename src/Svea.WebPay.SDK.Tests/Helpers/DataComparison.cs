...
public class DataComparison
{
    ...
    private static bool PaymentOrderRowsAreEqual(PaymentOrderRow expectedRow, PaymentOrderRow actualRow)
    {
    ...
    private static bool DeliveriesAreEqual(Delivery expectedDelivery, Delivery actualDelivery)
    {
    ...
    private static bool CreditsAreEqual(Credit expectedCredit, Credit actualCredit)
    {
    ...
    private static bool CheckoutOrderRowsAreEqual(CheckoutOrderRow expectedRow, CheckoutOrderRow actualRow)
    {
    ...
    private static bool PresetValuesAreEqual(Presetvalue expected, Presetvalue actual)
    {
