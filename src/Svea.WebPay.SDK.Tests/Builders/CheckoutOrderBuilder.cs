...
public class CheckoutOrderBuilder
{
    ...
    public CheckoutOrderBuilder UseTestValues()
    {
        ...
        cart = new Cart(orderRows);
        merchantSettings = new MerchantSettings(pushUri, termsUri, checkoutUri, confirmationUri);
        countryCode = new RegionInfo("SE");
        currency = new CurrencyCode("SEK");
        locale = new Language("sv-SE");
