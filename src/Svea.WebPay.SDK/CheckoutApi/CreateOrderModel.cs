...
namespace Svea.WebPay.SDK.CheckoutApi
{
    ...
    public class CreateOrderModel
    {
        ...
        public CreateOrderModel(RegionInfo countryCode, CurrencyCode currency, Language locale, string clientOrderNumber,
            ...
            IdentityFlags identityFlags = null, Guid? partnerKey = null, string merchantData = null, ShippingInformation shippingInformation = null, OrderValidation orderValidation=null)
        {
