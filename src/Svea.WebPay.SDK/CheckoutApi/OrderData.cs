...
namespace Svea.WebPay.SDK.CheckoutApi
{
    public class OrderData
    {
        ...
        /// <param name="billingReferences"></param>
        ...
        public OrderData(MerchantSettings merchantSettings, Cart cart, Customer customer, Address shippingAddress, Address billingAddress, string locale, string currency,
            ...
            BillingReferenceModel[] billingReferences,  bool? recurring, string recurringToken = null, OrderValidation validation = null)
        {
        ...
        [JsonInclude]
        public BillingReferenceModel[] BillingReferences { get; }
